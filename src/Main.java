...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    // 5 Куда будет обращение определяет не тип ссылки, а куда она ссылается (чем проинициализирована)(к какому полю или методу будет обращение)
    ...
    student6.method4(); // это вызов перекрытого статического метода можно только скрыть
